...
class Star(object):
    # CITATION: image from http://www.iconarchive.com/show/colobrush-
    # icons-by-gianni-polito/system-star-icon.html
    img = pygame.image.load(os.path.join("images", "star.png"))
